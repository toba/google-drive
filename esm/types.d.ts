...
export declare type GetFileParams = drive_v3.Params$Resource$Files$Get;
export declare type ListFilesParams = drive_v3.Params$Resource$Files$List;
export declare type DriveFileList = drive_v3.Schema$FileList;
export declare type DriveFile = drive_v3.Schema$File;
export declare type GetFileResponse = GaxiosResponse<DriveFile>;
export declare type GetFileListResponse = GaxiosResponse<DriveFileList>;
export declare type RequestError = GaxiosError;
/**
...
export declare const enum ResponseAlt {
    /**
 ...
 */
export declare const enum AuthPrompt {
    /**
 ...
 */
export declare const enum QuerySpace {
    Drive = "drive",
    Photos = "photos",
 ...
 */
export declare const enum Corpora {
    User = "user",
    Domain = "domain",
    TeamDrive = "teamDrive",
    /**
